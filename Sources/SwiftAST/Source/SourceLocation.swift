/*
   Copyright 2015-2016 Ryuichi Intellectual Property and the Yanagiba project contributors
...
public struct SourceLocation: Equatable, Hashable, SourceLocatable {
  public let identifier: String
  public let line: Int
  public let column: Int
  
  public var sourceRange: SourceRange {SourceRange(start:self, end: self)}
